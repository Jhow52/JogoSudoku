...
public class MainScreen {
    ...
    private JToggleButton toggleRascunhoButton;
    ...
    public void buildMainScreen(){
        ...
        addRascunhoToggleButton(mainPanel);
    ...
    private JPanel generateSection(final List<Space> spaces){
        ...
        for (Space space : spaces) {
            fields.add(new NumberText(space, boardService));
        }
    ...
    private void addFinishGameButton(JPanel mainPanel) {
        finishGameButton = new FinishGameButton(e -> {
            if(boardService.gameIsFinished()){
                ...
                JOptionPane.showMessageDialog(null, "Seu jogo tem alguma erro, ajuste");
            }
        });
    ...
    private void addRascunhoToggleButton(JPanel mainPanel) {
        toggleRascunhoButton = new JToggleButton("Rascunho");
        toggleRascunhoButton.addItemListener(e -> {
            boardService.setModoRascunho(toggleRascunhoButton.isSelected());
        });
        mainPanel.add(toggleRascunhoButton);
    }
}